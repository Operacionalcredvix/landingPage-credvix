const headerHTML = `
        <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                <a href="index.html"><img src="/img/logo-credvix.webp" alt="Logo Grupo Credvix" width="122" height="40" class="h-8 md:h-10"
                ...
                <a href="index.html"><img src="/img/logo-help.webp" alt="Logo Help!" width="70" height="40" class="h-8 md:h-10"
...
<span class="material-icons mr-3 mt-1 text-credvix-orange flex-shrink-0">schedule</span>
            ...
            <div class="mt-10 pt-6 border-t border-gray-700 text-center">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer">
                    <img src="/img/apis.webp" alt="Logo Apis Grupo" width="85" height="48" class="h-12 mx-auto"
